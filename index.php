...
<!-- MODAL AMARELO -->
<button type="button" id="amare" class="btn btn-warning btn-circle btn-lg" data-toggle="modal" data-target="#myModal1"><i class="glyphicon glyphicon-remove">TIP</i></button>
...
<div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Dica da pergunta escolhida, busca seria feita no banco de dados.</p>
      </div>
      <div class="modal-footer">
        <button id="btn-dica" type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div>
...
<!-- MODAL VERMELHO -->
<button type="button" id="red" class="btn btn-danger btn-circle btn-lg" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-heart">X</i></button>
...
<div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Deseja realmente abandonar o jogo?</p>
      </div>
      <div class="modal-footer">
        <button id="btn-sair-con" type="button" class="btn btn-default" data-dismiss="modal">Continuar</button>
        <button id ="btn-sair" type="button" class="btn btn-default" data-dismiss="modal">Sair</button>
      </div>
    </div>
  </div>
</div>
